...
export default function ZeroYenItems() {
  ...
  const starConfigs = [
    { top: '10%', left: '5%', width: '30%', color: 'sky-400', brightness: 0.9, gradStop: '10%', thickness: 'h-[1.5px]', blur: 'blur-[1px]' },
    { top: '25%', left: '40%', width: '50%', color: 'cyan-400', brightness: 0.7, gradStop: '50%', thickness: 'h-[1px]', blur: 'blur-[2px]' },
    { top: '50%', right: '10%', width: '40%', color: 'sky-300', brightness: 0.6, gradStop: '90%', thickness: 'h-[1px]', blur: 'blur-[1.5px]' },
    { top: '15%', right: '35%', width: '25%', color: 'sky-400', brightness: 0.85, gradStop: '15%', thickness: 'h-[1.5px]', blur: 'blur-[1px]' },
    { top: '35%', left: '15%', width: '45%', color: 'cyan-400', brightness: 0.75, gradStop: '50%', thickness: 'h-[1px]', blur: 'blur-[1.5px]' },
    { top: '60%', right: '40%', width: '35%', color: 'sky-300', brightness: 0.65, gradStop: '85%', thickness: 'h-[1px]', blur: 'blur-[2px]' },
    { bottom: '10%', left: '10%', width: '30%', color: 'sky-400', brightness: 0.9, gradStop: '10%', thickness: 'h-[1.5px]', blur: 'blur-[1px]' },
    { bottom: '25%', right: '15%', width: '50%', color: 'cyan-400', brightness: 0.7, gradStop: '50%', thickness: 'h-[1px]', blur: 'blur-[2px]' },
    { bottom: '50%', left: '35%', width: '40%', color: 'sky-300', brightness: 0.6, gradStop: '90%', thickness: 'h-[1px]', blur: 'blur-[1.5px]' },
    { bottom: '15%', right: '5%', width: '25%', color: 'sky-400', brightness: 0.85, gradStop: '15%', thickness: 'h-[1.5px]', blur: 'blur-[1px]' },
    { bottom: '35%', left: '50%', width: '45%', color: 'cyan-400', brightness: 0.75, gradStop: '50%', thickness: 'h-[1px]', blur: 'blur-[1.5px]' },
    { bottom: '60%', right: '50%', width: '35%', color: 'sky-300', brightness: 0.65, gradStop: '85%', thickness: 'h-[1px]', blur: 'blur-[2px]' },
  ];
  ...
  return (
    <section id="zero-yen" className={`${sectionPadding} relative bg-[#050A15] text-slate-400 overflow-hidden`}>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        {/* 💡 【追加】淡い光を2か所（広がり強め・薄め） */}
        {/* ① 左上の広大な光の広がり */}
        <div className="absolute top-[-10%] left-[-10%] w-[800px] h-[700px] bg-sky-500/10 blur-[150px] rounded-full" />
        {/* ② 右下の柔らかなシアンの広がり */}
        <div className="absolute bottom-[-15%] right-[-5%] w-[900px] h-[800px] bg-cyan-400/10 blur-[180px] rounded-full" />
        ...
        <div className="opacity-80">
          {starConfigs.map((star, i) => (
            <div
              key={i}
              className={`absolute rounded-full rotate-[-15deg] ${star.thickness} ${star.blur}`}
              style={{
                top: star.top,
                bottom: star.bottom,
                left: star.left,
                right: star.right,
                width: star.width,
                backgroundImage: `linear-gradient(to right, transparent, ${starHex[star.color as keyof typeof starHex]} ${star.gradStop}, transparent)`,
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          {/* 🔴 Item Grid Board */}
          <motion.div 
            className={`relative overflow-hidden ${cardRounded} ${glassBorder} shadow-[0_40px_80px_rgba(0,0,0,0.8)] py-8 sm:py-14 px-6 sm:px-12 mb-20 sm:mb-24 bg-transparent flex flex-col`}
            style={gpuStyle}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
            {/* 💡 【カード背景：PainManagement同期】 */}
            ...
            {/* 💡 【光源は下部】シャープかつ滑らかに滲み出る美しく上質な静的レイヤー光 */}
          ...
          >
            <div 
              className={`relative overflow-hidden flex flex-col md:flex-row items-center gap-4 px-8 py-5 rounded-xl ${glassBorder} shadow-[0_40px_80px_rgba(0,0,0,0.8)] bg-transparent w-full max-w-4xl mx-auto`}
              style={gpuStyle}
            >
              <div className="absolute inset-0 bg-slate-900/40 backdrop-blur-3xl z-0" />
