  ...
  measures: [
    {
      ...
      image: "https://lh3.googleusercontent.com/d/1tY1yy5gi5AVXtVseSm-DsWHWZZ780xzm", // ★先ほど生成したコストグラフ画像
      subTitle: "5年間で約200万円。生涯続く買い替えと増毛費用",
    ...
    },
    {
      ...
      image: "https://lh3.googleusercontent.com/d/1Hc9osc5HM7mHgHmA9FT4elL1S6Xs5jMV", // ★[次に作成] ダウングレードを表現する画像
      subTitle: "月々数千円〜の「維持期」へ賢く移行",
      description: "医療発毛は最初の半年〜1年（発毛集中期）こそ一定の投資が必要ですが、理想のボリュームに達した後は高額な治療を卒業。抜け毛を防ぐ「安価な内服薬のみ」のプランへダウングレードし、手に入れた髪を低コストで実感いただけます。"
    }
